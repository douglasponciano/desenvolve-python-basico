...
#mprima o tipo de dados dessas duas variáveis
#ivida a primeira variável (com o valor 5) pela segunda variável (com o valor 2) e armazene o resultado em uma terceira variável
